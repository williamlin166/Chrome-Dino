...
{
    //Initialize
   // std::cout<<"* LTexture constructor called\n";
    mTexture = NULL;
    mWidth = 0;
    mHeight = 0;
}
...
LTexture::~LTexture()
{
  //  std::cout<<"* LTexture destructor called\n";
	//Deallocate
    ~(*this);
}
...
{
    //std::cout<<"* loadFromFile function called\n";
